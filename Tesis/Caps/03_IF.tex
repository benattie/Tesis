...
Finally, the values obtained for each pole figure were averaged to produce the $\rho_{Langford}$, $\rho_{Langford}^{Size}$, $\rho_{Langford}^{Strain}$ shown in Table \ref{tab:rhocomp}
