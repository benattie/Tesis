...
\title{Integración de la Microestructura de aleaciones metálicas a partir de diferentes modelos para el análisis de Experimentos de Difracción}
...
\include{./Caps/01_intro}
\include{./Caps/02_Metodos}
\include{./Caps/03_IF}
\include{./Caps/04_F138}
\include{./Caps/05_G2205}
\include{./Caps/06_Al}
\include{./Caps/07_Conclusiones}
\include{./Caps/08_Proyecciones}

%\appendix
%\include{./Apendice/tablas}

\begin{biblio}
  \bibliography{./bib/tesis_lib,./bib/Physical_Properties_of_Crystals.bib,./bib/International_Tables_for_Crystallography.bib}
\end{biblio}
